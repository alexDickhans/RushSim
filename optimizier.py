...
motor_count = 8  # Number of motors
...
optimal_ratio, optimal_time = find_optimal_ratio(target_distance, motor_count, gear, wheel_radius, robot_mass, friction_coefficient, ratio_range)
